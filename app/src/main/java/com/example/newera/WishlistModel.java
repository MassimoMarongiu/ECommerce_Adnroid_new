...
public class WishlistModel {
    ...
    public WishlistModel(int productImage, String productTile, int freeCoupens, String rating, int totalRatings, String productPrice, String cuttedPrice, String paymentMethod) {
