...
public class CartItemModel {
    ...
    public CartItemModel(int type, int productImage, String productTitle, int feeCoupens, String productPrice, String cuttedPrice, int productQuantity, int offersApplied, int coupensApplied) {
        this.type = type;
        this.productImage = productImage;
        this.productTitle = productTitle;
        this.feeCoupens = feeCoupens;
    ...
    public int getFeeCoupens() {
        return feeCoupens;
    }

    public void setFeeCoupens(int feeCoupens) {
        this.feeCoupens = feeCoupens;
    }
