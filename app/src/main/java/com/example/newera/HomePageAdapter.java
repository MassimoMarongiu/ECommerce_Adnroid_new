...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            ...
            case HomePageModel.STRIP_AD_BANNER:
                ...
                return new StripAdViewBannerHolder(stripAdView);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (homePageModelList.get(position).getType()) {
            ...
            case HomePageModel.STRIP_AD_BANNER:
                ...
                ((StripAdViewBannerHolder) holder).setStripeAd(resource, color);
                break;
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
    ...
    public class StripAdViewBannerHolder extends RecyclerView.ViewHolder {
        private ImageView stripAdImage;
        private ConstraintLayout stripAdContainer;

        public StripAdViewBannerHolder(@NonNull View itemView) {
            super(itemView);
            stripAdImage = itemView.findViewById(R.id.strip_ad_image);
            stripAdContainer = itemView.findViewById(R.id.strip_ad_container);
        }

        private void setStripeAd(int resource, String color) {
    ...
    public class HorizontalProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public HorizontalProductViewHolder(@NonNull View itemView) {
            ...
            horizontalReciclerView = itemView.findViewById(R.id.horizontal_scroll_layout_reciclerView);
        }
