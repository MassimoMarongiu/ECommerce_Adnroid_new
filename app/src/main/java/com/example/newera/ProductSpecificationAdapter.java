...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    private List<Product_SpecificationModel> productSpecificationModelList;

    public ProductSpecificationAdapter(List<Product_SpecificationModel> productSpecificationModelList) {
    ...
    public int getItemViewType(int position) {
        switch (productSpecificationModelList.get(position).getType()) {
            case 0:
                return Product_SpecificationModel.SPECIFICATION_TITLE;
            case 1:
                return Product_SpecificationModel.SPECIFICATION_BODY;
    ...
    public ProductSpecificationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case Product_SpecificationModel.SPECIFICATION_TITLE:
            ...
            case Product_SpecificationModel.SPECIFICATION_BODY:
...
//            richiamato da  switch (viewType) {case Product_SpecificationModel.SPECIFICATION_TITLEate
